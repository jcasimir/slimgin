...
# ====== Benchmark Skeleton ======
# Benchmark.bm do |performance|               # => Benchmark
#   performance.report('thing1') { "stuff" }  # => #<Benchmark::Tms:0x007f8f0b074788 @label="thing1", @real=2.6150373741984367e-06, @cstime=0.0, @cutime=0.0, @stime=0.0, @utime=0.0, @total=0.0>
#   performance.report('thing2') { "stuff" }  # => #<Benchmark::Tms:0x007f8f0b06f940 @label="thing2", @real=1.7980346456170082e-06, @cstime=0.0, @cutime=0.0, @stime=0.0, @utime=0.0, @total=0.0>
#   performance.report('thing3') { "stuff" }  # => #<Benchmark::Tms:0x007f8f0b06e7e8 @label="thing3", @real=1.6060075722634792e-06, @cstime=0.0, @cutime=0.0, @stime=0.0, @utime=0.0, @total=0.0>
# end                                         # => [#<Benchmark::Tms:0x007f8f0b074788 @label="thing1", @real=2.6150373741984367e-06, @cstime=0.0, @cutime=0.0, @stime=0.0, @utime=0.0, @total=0.0>, #<Benchmark::Tms:0x007f8f0b06f940 @label="thing2", @real=1.7980346456170082e-06, @cstime=0.0, @cutime=0.0, @stime=0.0, @utime=0.0, @total=0.0>, #<Benchmark::Tms:0x007f8f0b06e7e8 @label="thing3", @real=1.6060075722634792e-06, @cstime=0.0, @cutime=0.0, @stime=0.0, @utime=0.0, @total=0.0>]

# ===== Loops =====

Benchmark.bmbm do |performance|
  n = 100   # Experiment with changing this number
  #performance.report {for i in (1..n) {|i| "hi" } }
  performance.report {n.times  { |i| 'hi' }}

  performance.report {1.upto(n) {|i| 'hi' }}
end
